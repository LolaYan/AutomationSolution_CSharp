...
namespace XeroAutomationConsoleApplication
{
    class BankAccountBase
    {
        ...
        public static string suffixSetting;
        ...
        public static string doMod()
        {
            do
            {
                ...
                else if (AlgorithmType.Equals("F") || AlgorithmType.Equals("G"))
                {
        ...
        public static void getBankAccountBaseStr()
        {
            ...
            if (AlgorithmType.Equals("E") || AlgorithmType.Equals("G"))
            {
                ...
                ranNoSuffix = RandomNumber(0, 999);
        ...
        public static int[] GetAlgorithmWeight(string AlgorithmType)
        {
            ...
            switch (AlgorithmType)
            {
                ...
                case "F":
                    ...
                    break;
                case "G":
                    int[] WeightNumberArrG = new int[18] { 0, 0, 0, 0, 0, 0, 0, 1, 3, 7, 1, 3, 7, 1, 0, 0, 0, 0 };
