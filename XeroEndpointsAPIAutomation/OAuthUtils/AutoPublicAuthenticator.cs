...
namespace XeroEndpointsAPIAutomation.OAuthUtils
{
    /// <summary>
    ///  Class for Public Authenticator, which is used for XeroCoreApi creation.
    ///  Feature 1: Override the AuthorizeUser function of Xero.Api.Example.Applications.Public.PublicAuthenticator
    ///  Feature 2: Instead of asking for the xero user to Authorise the public application, here we automate the standard 3 legged OAuth process using selenium web driver.
    ///  Note 1: All the authorisation url and xero user credentials are configured in Project.Properties.Settins.
    /// </summary>
